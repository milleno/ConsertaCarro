...
mysql_select_db($database_consertacarros, $consertacarros);
$query_RsAdmin = "SELECT * FROM usuarios";
$RsAdmin = mysql_query($query_RsAdmin, $consertacarros) or die(mysql_error());
...
<body>
	...
	<section class="container">
		<div class="heading">
		  ...
		  <table align="center">
			  <tr>
			    <td width="199" bgcolor="#99FFCC">Nome</td>
			    <td width="143" bgcolor="#99FFCC">e-mail</td>
			    <td width="123" bgcolor="#99FFCC">&nbsp;</td>
		      </tr>
			  <?php do { ?>
			  <tr>
			    <td><?php echo $row_RsAdmin['nome']; ?>&nbsp; </td>
			    <td><?php echo $row_RsAdmin['email']; ?>&nbsp; </td>
			    <td><a href="adm_usuarios_edit.php?recordID=<?php echo $row_RsAdmin['id']; ?>" class="btn"> editar	</a></td>
		      </tr>
			  <tr>
			    <td height="43"   colspan="3"><hr></td>
		    </tr>
			  <?php } while ($row_RsAdmin = mysql_fetch_assoc($RsAdmin)); ?>
		  </table>
			<br>
            <?php echo $totalRows_RsAdmin ?> Registros Total </div>
