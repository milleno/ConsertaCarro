...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE produtos SET titulo=%s, subtitulo=%s, descritivo=%s, imagem=%s, link=%s WHERE id=%s",
...
mysql_select_db($database_consertacarros, $consertacarros);
$query_DetailRS1 = sprintf("SELECT * FROM produtos WHERE id = %s", GetSQLValueString($colname_DetailRS1, "int"));
	...
	<div class="container">
		<div class="row">
			...
			<section class="col-sm-12 maincontent">
				<h3>Bem vindo a área administrativa ConsertaCarros - PRODUTOS </h3>
				<p>
            ...
            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
              <table align="center">
                ...
                <tr valign="baseline">
                  ...
                  <td><input type="text" name="subtitulo" value="<?php echo htmlentities($row_DetailRS1['subtitulo'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                </tr>
                <tr valign="baseline">
                  <td nowrap align="right" valign="top">Descritivo:</td>
                  <td><textarea name="descritivo" cols="50" rows="5"><?php echo htmlentities($row_DetailRS1['descritivo'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
                </tr>
                <tr valign="baseline">
                  <td nowrap align="right">Imagem:</td>
                  <td><input type="text" name="imagem" value="<?php echo htmlentities($row_DetailRS1['imagem'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                </tr>
                <tr valign="baseline">
                  <td nowrap align="right">Link:</td>
                  <td><input type="text" name="link" value="<?php echo htmlentities($row_DetailRS1['link'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                </tr>
                <tr valign="baseline">
