...
mysql_select_db($database_consertacarros, $consertacarros);
$query_RsProdutos = "SELECT * FROM produtos";
$RsProdutos = mysql_query($query_RsProdutos, $consertacarros) or die(mysql_error());
...
<body>
	...
	<section class="container">
		<div class="heading">
			...
			<table align="center">
			  <tr>
			    <td width="303" bgcolor="#CECEFF">TÍtulo</td>
			    <td width="217" bgcolor="#CECEFF">SubtÍtulo</td>
			    <td width="132">&nbsp;</td>
		      </tr>
			  <?php do { ?>
			  <tr>
			    <td> <?php echo $row_RsProdutos['titulo']; ?>&nbsp; </td>
			    <td><?php echo $row_RsProdutos['subtitulo']; ?>&nbsp; </td>
			    <td><a href="adm_produtos_edit.php?recordID=<?php echo $row_RsProdutos['id']; ?>" class="btn">EDITAR		</a></td>
		      </tr>
			  <tr>
			    <td height="27" colspan="3"><hr></td>
		      </tr>
			  <?php } while ($row_RsProdutos = mysql_fetch_assoc($RsProdutos)); ?>
		  </table>
			<br>
            <?php echo $totalRows_RsProdutos ?> Registros Total
            </p>
<br />
		</div>
