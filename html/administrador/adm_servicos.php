...
mysql_select_db($database_consertacarros, $consertacarros);
$query_RsServ = "SELECT * FROM servicos";
$RsServ = mysql_query($query_RsServ, $consertacarros) or die(mysql_error());
$row_RsServ = mysql_fetch_assoc($RsServ);
$totalRows_RsServ = mysql_num_rows($RsServ);
	...
	<section class="container">
		<div class="heading">
			...
			<table border="1" align="center">
			  ...
			  <?php do { ?>
			  <tr>
			    <td><a href="adm_servicos_edit.php?recordID=<?php echo $row_RsServ['id']; ?>"> <?php echo $row_RsServ['titulo']; ?>&nbsp; </a></td>
			    <td><?php echo $row_RsServ['sutitulo']; ?>&nbsp; </td>
		      </tr>
			  <?php } while ($row_RsServ = mysql_fetch_assoc($RsServ)); ?>
		  </table>
			<br>
            <?php echo $totalRows_RsServ ?> Registros Total
            </p>
		</div>
