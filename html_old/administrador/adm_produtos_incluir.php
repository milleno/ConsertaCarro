...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO produtos (titulo, subtitulo, descritivo, imagem, link) VALUES (%s, %s, %s, %s, %s)",
  ...
  $Result1 = mysql_query($insertSQL, $consertacarros) or die(mysql_error());

  $insertGoTo = "inserido.php";
  if (isset($_SERVER['QUERY_STRING'])) {
	...
	<div class="container">
		<div class="row">
			...
			<section class="col-sm-12 maincontent">
				<h3>Bem vindo a área administrativa ConsertaCarros</h3>
				<p>
					Bem vindo a sua área administrativa, aquui você poderá incluir, excluir e editar o conteúdo de seu site.
				</p>
          ...
          <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
            <table align="center">
              ...
              <tr valign="baseline">
                ...
                <td><input type="text" name="subtitulo" value="" size="60"></td>
              </tr>
              <tr valign="baseline">
                <td nowrap align="right" valign="top">Descritivo:</td>
                <td><textarea name="descritivo" cols="60" rows="5"></textarea></td>
              </tr>
              <tr valign="baseline">
                <td nowrap align="right">Imagem:</td>
                <td><input type="text" name="imagem" value="" size="60"></td>
              </tr>
              <tr valign="baseline">
