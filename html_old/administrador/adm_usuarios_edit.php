...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE usuarios SET nome=%s, email=%s, senha=%s WHERE id=%s",
...
mysql_select_db($database_consertacarros, $consertacarros);
$query_DetailRS2 = sprintf("SELECT * FROM usuarios WHERE id = %s", GetSQLValueString($colname_DetailRS2, "int"));
$DetailRS2 = mysql_query($query_DetailRS2, $consertacarros) or die(mysql_error());
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<section class="col-sm-12 maincontent">
				<h3>Bem vindo a área administrativa ConsertaCarros - ADMINISTRADORES</h3>
				<p>
	...
	<section class="container">
		<div class="heading">
			<!-- Heading -->
			<p>&nbsp;<table width="235" border="1" align="center">
  
  <tr>
    <td>nome</td>
    <td><?php echo $row_DetailRS2['nome']; ?></td>
  </tr>
  <tr>
    <td>email</td>
  ...
  <tr>
    <td>senha</td>
    <td><?php echo $row_DetailRS2['senha']; ?> </td>
  </tr>
            ...
            <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
              <table align="center">
                <tr valign="baseline">
                  ...
                  <td><input type="text" name="nome" value="<?php echo htmlentities($row_DetailRS2['nome'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                </tr>
                <tr valign="baseline">
                  <td nowrap align="right">Email:</td>
                  <td><input type="text" name="email" value="<?php echo htmlentities($row_DetailRS2['email'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                </tr>
                <tr valign="baseline">
                  <td nowrap align="right">Senha:</td>
                  <td><input type="text" name="senha" value="<?php echo htmlentities($row_DetailRS2['senha'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                </tr>
                <tr valign="baseline">
              ...
              <input type="hidden" name="id" value="<?php echo $row_DetailRS2['id']; ?>">
            </form>
            <p>&nbsp;</p>
          </p>
			<p><br />
